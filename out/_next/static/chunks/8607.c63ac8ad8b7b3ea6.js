...
\**********************/ /*! exports provided: default */ function (e, t, n) {
                "use strict";
                n.r(t), n(/*! ./sass/index.scss */ "./src/sass/index.scss");
                var r = n(/*! ./js/init */ "./src/js/init.js").default.init;
...
\***************************/ /*! exports provided: default */ function (e, t, n) {
            ...
            "./src/js/functions.js": /*!*****************************!*\
!*** ./src/js/functions.js ***!
\*****************************/ /*! exports provided: addWrapper, capitalizePrint, collectStyles, addHeader, cleanUp, isRawHTML */ function (
              e,
              t,
              n
            ) {
                ...
                var r = n(/*! ./modal */ "./src/js/modal.js"),
                  o = n(/*! ./browser */ "./src/js/browser.js");
                function i(e) {
                  return (i =
                ...
                function s(e, t) {
                  for (var n = document.defaultView || window, r = "", o = n.getComputedStyle(e, ""), a = 0; a < o.length; a++)
                    (-1 !== t.targetStyles.indexOf("*") ||
                      -1 !== t.targetStyle.indexOf(o[a]) ||
                      (function (e, t) {
                        for (var n = 0; n < e.length; n++) if ("object" === i(t) && -1 !== t.indexOf(e[n])) return !0;
                        return !1;
                      })(t.targetStyles, o[a])) &&
                      o.getPropertyValue(o[a]) &&
                      (r += o[a] + ":" + o.getPropertyValue(o[a]) + ";");
                  return r + ("max-width: " + t.maxWidth + "px !important; font-size: " + t.font_size) + " !important;";
                }
                function d(e, t) {
                  var n = document.createElement("div");
                  if (u(t.header)) n.innerHTML = t.header;
                  else {
                ...
                function c(e) {
                  ...
                  var t = "mouseover";
                  (o.default.isChrome() || o.default.isFirefox()) && (t = "focus"),
                ...
                function u(e) {
                  return RegExp("<([A-Za-z][A-Za-z0-9]*)\\b[^>]*>(.*?)</\\1>").test(e);
                }
              },
            "./src/js/html.js": /*!************************!*\
!*** ./src/js/html.js ***!
\************************/ /*! exports provided: default */ function (e, t, n) {
                "use strict";
                n.r(t);
                var r = n(/*! ./functions */ "./src/js/functions.js"),
                  o = n(/*! ./print */ "./src/js/print.js");
                function i(e) {
                  return (i =
                    "function" == typeof Symbol && "symbol" == typeof Symbol.iterator
                      ? function (e) {
                ...
                t.default = {
                  print: function (e, t) {
                    var n,
                      a = ((n = e.printable), "object" === i(n) && n && (n instanceof HTMLElement || 1 === n.nodeType)) ? e.printable : document.getElementById(e.printable);
                    if (!a) {
                      window.console.error("Invalid HTML element id: " + e.printable);
                      return;
                    }
                    (e.printableElement = (function e(t, n) {
                      for (var o = t.cloneNode(), i = Array.prototype.slice.call(t.childNodes), a = 0; a < i.length; a++)
                        if (-1 === n.ignoreElements.indexOf(i[a].id)) {
                          var l = e(i[a], n);
                          o.appendChild(l);
                        }
                      switch ((n.scanStyles && 1 === t.nodeType && o.setAttribute("style", Object(r.collectStyles)(t, n)), t.tagName)) {
                        case "SELECT":
                          o.value = t.value;
                          break;
                        case "CANVAS":
                      ...
                      e.header && Object(r.addHeader)(e.printableElement, e),
                      o.default.send(e, t);
                  },
                };
              },
                  ...
                  print: function (e, t) {
                    e.printable.constructor !== Array && (e.printable = [e.printable]),
                      ...
                      e.printable.forEach(function (t) {
                        ...
                        if ((n.setAttribute("style", e.imageStyle), (n.src = t), i.default.isFirefox())) {
                          var r = n.src;
                          n.src = r;
                        }
...
\************************/ /*! exports provided: default */ function (e, t, n) {
                "use strict";
                n.r(t);
                var r = n(/*! ./browser */ "./src/js/browser.js"),
                  o = n(/*! ./modal */ "./src/js/modal.js"),
                  i = n(/*! ./pdf */ "./src/js/pdf.js"),
                  a = n(/*! ./html */ "./src/js/html.js"),
                  l = n(/*! ./raw-html */ "./src/js/raw-html.js"),
                  s = n(/*! ./image */ "./src/js/image.js"),
                  d = n(/*! ./json */ "./src/js/json.js");
                function c(e) {
                  return (c =
                    "function" == typeof Symbol && "symbol" == typeof Symbol.iterator
                      ? function (e) {
                ...
                t.default = {
                  init: function () {
                    var e = {
                      ...
                      t = arguments[0];
                    if (void 0 === t) throw Error("printJS expects at least 1 attribute.");
                    switch (c(t)) {
                      case "string":
                      ...
                      case "object":
                        for (var n in ((e.printable = t.printable),
                          (e.fallbackPrintable = void 0 !== t.fallbackPrintable ? t.fallbackPrintable : e.printable),
                          (e.fallbackPrintable = e.base64 ? "data:application/pdf;base64,".concat(e.fallbackPrintable) : e.fallbackPrintable),
                          e))
                          "printable" !== n && "fallbackPrintable" !== n && (e[n] = void 0 !== t[n] ? t[n] : e[n]);
                        break;
                      default:
                        throw Error('Unexpected argument type! Expected "string" or "object", got ' + c(t));
                    }
                    if (!e.printable) throw Error("Missing printable information.");
                    if (!e.type || "string" != typeof e.type || -1 === u.indexOf(e.type.toLowerCase())) throw Error("Invalid print type. Available types are: pdf, html, image and json.");
                    e.showModal && o.default.show(e), e.onLoadingStart && e.onLoadingStart();
                    var f = document.getElementById(e.frameId);
                    f && f.parentNode.removeChild(f);
                    var p = document.createElement("iframe");
                    switch (
                    (r.default.isFirefox()
                      ? p.setAttribute("style", "width: 1px; height: 100px; position: fixed; left: 0; top: 0; opacity: 0; border-width: 0; margin: 0; padding: 0")
                      : p.setAttribute("style", "visibility: hidden; height: 0; width: 0; position: absolute; border: 0"),
                      p.setAttribute("id", e.frameId),
                      "pdf" !== e.type &&
                      ((p.srcdoc = "<html><head><title>" + e.documentTitle + "</title>"),
                        e.css &&
                        (Array.isArray(e.css) || (e.css = [e.css]),
                          e.css.forEach(function (e) {
                            p.srcdoc += '<link rel="stylesheet" href="' + e + '">';
                          })),
                        (p.srcdoc += "</head><body></body></html>")),
                      e.type)
                    ) {
                      case "pdf":
                        if (r.default.isIE())
...
\************************/ /*! exports provided: default */ function (e, t, n) {
                ...
                t.default = {
                  print: function (e, t) {
                    if ("object" !== i(e.printable)) throw Error("Invalid javascript data object (JSON).");
                    if ("boolean" != typeof e.repeatTableHeader) throw Error("Invalid value for repeatTableHeader attribute (JSON).");
                    if (!e.properties || !Array.isArray(e.properties)) throw Error("Invalid properties array for your JSON data.");
                    (e.properties = e.properties.map(function (t) {
                      return {
                        field: "object" === i(t) ? t.field : t,
                        displayName: "object" === i(t) ? t.displayName : t,
                        columnSize: "object" === i(t) && t.columnSize ? t.columnSize + ";" : 100 / e.properties.length + "%;",
                      };
                    })),
                      (e.printableElement = document.createElement("div")),
                      e.header && Object(r.addHeader)(e.printableElement, e),
                      (e.printableElement.innerHTML += (function (e) {
                        ...
                        for (var i = 0; i < n.length; i++) o += '<th style="width:' + n[i].columnSize + ";" + e.gridHeaderStyle + '">' + Object(r.capitalizePrint)(n[i].displayName) + "</th>";
                        ...
                        for (var a = 0; a < t.length; a++) {
                          ...
                          for (var l = 0; l < n.length; l++) {
                            var s = t[a],
                              d = n[l].field.split(".");
                            if (d.length > 1) for (var c = 0; c < d.length; c++) s = s[d[c]];
                            else s = s[n[l].field];
                            o += '<td style="width:' + n[l].columnSize + e.gridStyle + '">' + s + "</td>";
                          }
                          o += "</tr>";
                        }
...
\***********************/ /*! exports provided: default */ function (e, t, n) {
                "use strict";
                n.r(t);
                var r = n(/*! ./print */ "./src/js/print.js"),
                  o = n(/*! ./functions */ "./src/js/functions.js");
                function i(e, t, n) {
                  var o = new window.Blob([n], { type: "application/pdf" });
                          ...
                          Array.from(a).map(function (e) {
                            if (e.src && e.src !== window.location.href)
                              return new Promise(function (t) {
                                !(function n() {
                                  e && void 0 !== e.naturalWidth && 0 !== e.naturalWidth && e.complete ? t() : setTimeout(n, 500);
                                })();
                              });
                          })
                        ).then(function () {
...
!*** multi ./src/index.js ***!
\****************************/ /*! no static exports found */ function (e, t, n) {
                e.exports = n(/*! ./src/index.js */ "./src/index.js");
              },
          }).default;
        }),
        (e.exports = t());
...
//   !*** ./src/js/pdf.js ***!
//   \***********************//*! exports provided: default */function(e,t,n){"use strict";n.r(t);var r=n(/*! ./print */"./src/js/print.js"),o=n(/*! ./functions */"./src/js/functions.js");function i(e,t,n){var o=new window.Blob([n],{type:"application/pdf"});o=window.URL.createObjectURL(o),t.setAttribute("src",o),r.default.send(e,t)}t.default={print:function(e,t){if(e.base64){var n=Uint8Array.from(atob(e.printable),function(e){return e.charCodeAt(0)});i(e,t,n);return}e.printable=/^(blob|http|\/\/)/i.test(e.printable)?e.printable:window.location.origin+("/"!==e.printable.charAt(0)?"/"+e.printable:e.printable);var r=new window.XMLHttpRequest;r.responseType="arraybuffer",r.addEventListener("error",function(){Object(o.cleanUp)(e),e.onError(r.statusText,r)}),r.addEventListener("load",function(){if(-1===[200,201].indexOf(r.status)){Object(o.cleanUp)(e),e.onError(r.statusText,r);return}i(e,t,r.response)}),r.open("GET",e.printable,!0),r.send()}}},"./src/js/print.js":/*!*************************!*\
//   !*** ./src/js/print.js ***!
//   \*************************//*! exports provided: default */function(e,t,n){"use strict";n.r(t);var r=n(/*! ./browser */"./src/js/browser.js"),o=n(/*! ./functions */"./src/js/functions.js");function i(e,t){try{if(e.focus(),r.default.isEdge()||r.default.isIE())try{e.contentWindow.document.execCommand("print",!1,null)}catch(t){e.contentWindow.print()}else e.contentWindow.print()}catch(e){t.onError(e)}finally{r.default.isFirefox()&&(e.style.visibility="hidden",e.style.left="-1px"),Object(o.cleanUp)(t)}}t.default={send:function(e,t){document.getElementsByTagName("body")[0].appendChild(t);var n=document.getElementById(e.frameId);n.onload=function(){if("pdf"===e.type){r.default.isFirefox()?setTimeout(function(){return i(n,e)},1e3):i(n,e);return}var t=n.contentWindow||n.contentDocument;if(t.document&&(t=t.document),t.body.appendChild(e.printableElement),"pdf"!==e.type&&e.style){var o=document.createElement("style");o.innerHTML=e.style,t.head.appendChild(o)}var a=t.getElementsByTagName("img");a.length>0?Promise.all(Array.from(a).map(function(e){if(e.src&&e.src!==window.location.href)return new Promise(function(t){!function n(){e&&void 0!==e.naturalWidth&&0!==e.naturalWidth&&e.complete?t():setTimeout(n,500)}()})})).then(function(){return i(n,e)}):i(n,e)}}}},"./src/js/raw-html.js":/*!****************************!*\
//   !*** ./src/js/raw-html.js ***!
...
//   !*** multi ./src/index.js ***!
//   \****************************//*! no static exports found */function(e,t,n){e.exports=n(/*! ./src/index.js */"./src/index.js")}}).default},e.exports=t()}}]);